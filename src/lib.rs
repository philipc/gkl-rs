...
pub fn pairhmm_avxs(hap: &[u8], rs: &[u8], q: &[u8], i: &[u8], d: &[u8], c: &[u8]) -> Option<f32> {
...
pub fn pairhmm_avxd(hap: &[u8], rs: &[u8], q: &[u8], i: &[u8], d: &[u8], c: &[u8]) -> Option<f64> {
    if !is_x86_feature_detected!("avx2") {
        return None;
    }
    convert_char_init();
